...
<template>
  <div class="px-32 py-12" id="home">
    <div class="flex justify-between items-center gap-12">
      <div class="space-y-8">
        <p class="font-bold text-7xl text-teal-800">Fullstack Developer</p>
        <p>
