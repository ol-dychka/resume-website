...
<template>
  <div class="fixed top-0 z-50 w-full">
    ...
    >
      <div class="relative">
        <p
          class="cursor-pointer duration-200 hover:text-teal-600"
          @click="copy"
        >
          ol.dychka@gmail.com
        </p>
        <p
          class="absolute -right-20 top-0 opacity-0 transition-opacity duration-500 ease-in-out"
          :class="{ 'opacity-100': showCopied }"
        >
          Copied!
        </p>
      </div>
      <a
        href="https://drive.google.com/file/d/1dRWGoM2LaJ7V90wHlxAYbbVJ8HGlykoh/view?usp=sharing"
        target="_blank"
